...
for (
  ...
  console.log(
    `Posicao ${controladorFor} valor lido = ${listaArgumentos[controladorFor]}`
  );
}
...
while (controladorWhile < listaArgumentos.length) {
  console.log(
    `Posicao ${controladorWhile} valor lido = ${listaArgumentos[controladorWhile]}`
  );
  controladorWhile++;
}
...
do {
  console.log(
    `Posicao ${controladorDoWhile} valor lido = ${listaArgumentos[controladorDoWhile]}`
  );
  controladorDoWhile++;
} while (controladorDoWhile < listaArgumentos.length);

console.log(
  "------------------------- Executando um DO FOR OF ----------------------------"
);
